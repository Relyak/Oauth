...
import com.myonlineshopping.jwt.JwtTokenFilter;
...
//                                .antMatchers("/products/**").hasAnyAuthority(ERole.ADMIN.name()) //admin puede hacer de todo probar cambiar el orden de director
